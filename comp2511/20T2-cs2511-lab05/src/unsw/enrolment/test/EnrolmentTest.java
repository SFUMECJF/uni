...
public class EnrolmentTest {
    ...
    public static void main(String[] args) {
        ...
        // Create new assignment/ass1
        comp1511Enrolment.addPrac();
        // Give passing mark to ass1/first assessment
        comp1511Enrolment.addMilestone("ass1", 20);

        // TODO Give the student a passing mark for milestone 1 of assignment 2
        
        // Create ass2
        comp1511Enrolment.addPrac();
        // give passing mark to milestone1
        comp1511Enrolment.addMilestone("ass2", 19);

        // TODO Give the student a passing mark for milestone 2 of assignment 2

        // gives passing mark forsecond milestone
        comp1511Enrolment.addMilestone("ass2", 15);
        ...
        // done when exam mark is set

        // TODO Give the student a passing exam mark.

        comp1511Enrolment.addExam(50);
