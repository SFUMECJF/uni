#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# pylint: disable= R0914, R1714, C0103, C0303, W0601, C0301, W0602, W0603, W0404, W0611, W0612, W0613, W0703, W0621, W0631, E0602, R0912
...
def channel_removeowner(token, u_id, channel_id):
    ...
    if owner_to_remove not in current_channel.get_owner_members():
        call_error.invalid_owner()
