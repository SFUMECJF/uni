...
# the request
# uses localised globals for simplicity. Other ways of storing could be into text or json files
# globals are only changed in this file and are not accessed anywhere else in the program. 
        ...
        # SHT
            ...
            if request['adminPassword'] == adminPsswd:
                ...
                for c in clients:
                    ...
                    c.close()
                break
            # failed password check for shutdown
            else:
